...
- [X] **Store current session in local cache** – Persist completedSets, editValues, and notes to AsyncStorage during a workout; restore on mount; clear on completion. Enables seamless resume across tab switches and app reopens.
